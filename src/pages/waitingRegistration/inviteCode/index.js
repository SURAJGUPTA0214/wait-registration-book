...
const InviteCode = () => {
  ...
  console.log('lllllll', waitingRegistration)
  ...
  return (
    <Card>
      <div className="d-flex justify-content-between">
        <h3>People with invite code</h3>
        <p>Count: {submissions?.length || 0}</p>
      </div>
      <div id="scrollableDivCode" style={{ height: "400px", overflowY: "auto" }}>
        <InfiniteScroll
          ...
          scrollableTarget="scrollableDivCode"
        >
          <List
            dataSource={data}
